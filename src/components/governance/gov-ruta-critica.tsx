...
const milestones = [
  ...
  { milestone: "Dashboard v1", tiempo: "Semana 2", costo: "Bajo", calidad: "Vista ejecutiva", resultado: "Adopción por área y herramienta", phase: 1 },
  { milestone: "Champions", tiempo: "Semana 3", costo: "Muy bajo", calidad: "1 por área clave", resultado: "Red interna de impulso", phase: 1 },
  ...
  { milestone: "Integración de fuentes", tiempo: "F2 Sem 3-4", costo: "Medio", calidad: "4 fuentes", resultado: "OpenAI, Anthropic, Gemini, Copilot", phase: 2 },
  { milestone: "Dashboard v2", tiempo: "F2 Sem 5-6", costo: "Medio", calidad: "Datos homologados", resultado: "Tokens, costo y uso", phase: 2 },
  { milestone: "Optimización", tiempo: "F2 Sem 7-8", costo: "Medio", calidad: "Recomendaciones", resultado: "Ahorro y valor", phase: 2 },
];
        ...
        <table className="w-full text-left min-w-[700px]">
          <thead>
            <tr className="border-b border-card-border">
              ...
              <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wider text-primary">Calidad</th>
